...
class Update:
    def __init__(self):
        self.version = "1.0"
        self.github = "https://raw.githubusercontent.com/ShredGman/Eclipse-Grabber/main/tools/update.py"
        self.zipfile = (
            "https://github.com/ShredGman/Eclipse-Grabber/archive/refs/heads/main.zip"
        )
        self.update_checker()
        ...
        if "self.version = '1.0'" in code:
            ...
            print(
                """
                    ...
                    ██║ ╚████║███████╗╚███╔███╔╝    ╚██████╔╝██║     ██████╔╝██║  ██║   ██║   ███████╗██╗
                    ╚═╝  ╚═══╝╚══════╝ ╚══╝╚══╝      ╚═════╝ ╚═╝     ╚═════╝ ╚═╝  ╚═╝   ╚═╝   ╚══════╝╚═╝
                                      Your version of Eclipse Token Grabber is outdated!"""
            )
